...
from blog.forms import PostSearchForm, UserSearchForm
...
@register.inclusion_tag('blog/includes/category_links_detail.html')
def render_category_links_detail():
    return {
        'category_list': Category.objects.all(),
    }

@register.inclusion_tag('blog/includes/category_links_nav.html')
def render_category_links_nav():
    return {
        'category_list': Category.objects.all(),
    }
...
def render_month_links():
    return {
        'dates': Post.objects.pubulished().dates('created_at', 'month', order='DESC'),
    }

@register.inclusion_tag('blog/includes/month_links_detail.html')
def render_month_links_detail():
    return {
        'dates': Post.objects.pubulished().dates('created_at', 'month', order='DESC'),
    }

@register.inclusion_tag('blog/includes/month_links_nav.html')
def render_month_links_nav():
    return {
        'dates': Post.objects.pubulished().dates('created_at', 'month', order='DESC'),
    }
...
@register.inclusion_tag('blog/includes/user_search_form.html')
def render_user_search_form(request):
